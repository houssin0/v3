      ...
      <Card sx={{ marginTop: 3 }}>
        <FlexBox flexDirection="column" alignItems="center" py={4}>
          <AvatarBadge
            ...
            sx={{ width: 60, height: 60, backgroundColor: "primary.100" }}
          />
  ...
  const rightContent = (
    <Card sx={{ height: "100%" }}>
      ...
      <FlexBox p={2} alignItems="center" justifyContent="space-between">
        <H6>Shared FIles</H6>
        <ButtonBase sx={{ color: "secondary.red" }} disableRipple>
          See all
        </ButtonBase>
      </FlexBox>
      ...
      <ScrollBar style={{ height: 200, paddingLeft: 16, paddingRight: 16 }}>
        <ListItem hideIcon />
        <ListItem hideIcon />
        <ListItem hideIcon />
        <ListItem hideIcon />
